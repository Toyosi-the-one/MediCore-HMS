...
export const routes: Routes = [
    ...
    children: [
      {
        path: 'dashboard',
        loadComponent: () =>
          import('./features/receptionist/dashboard/dashboard.component')
            .then(m => m.DashboardComponent)
      },
      {
        path: 'queue',
        loadComponent: () =>
          import('./features/receptionist/queue-dashboard/queue-dashboard.component')
            .then(m => m.QueueDashboardComponent)
      },
      {
        path: 'patients/new',
        loadComponent: () =>
          import('./features/receptionist/patient-registration/patient-registration.component')
            .then(m => m.PatientRegistrationComponent)
      },
      {
        path: 'patients/edit/:id',
        loadComponent: () =>
          import('./features/receptionist/edit-patient/edit-patient.component')
            .then(m => m.EditPatientComponent)
      },
      {
        path: 'patients',
        loadComponent: () =>
          import('./features/receptionist/patient-list/patient-list.component')
            .then(m => m.PatientListComponent)
      },
      {
        path: 'appointments/new',
        loadComponent: () =>
          import('./features/receptionist/schedule-appointment/schedule-appointment.component')
            .then(m => m.ScheduleAppointmentComponent)
      },
      {
        path: 'appointments',
        loadComponent: () =>
          import('./features/receptionist/appointment-list/appointment-list.component')
  ...
  // leaving /patient/* to be matched by the layout route below.
  {
    ...
    pathMatch: 'full',
    loadComponent: () =>
      import('./features/patient/patient-entry/patient-entry.component')
        .then(m => m.PatientEntryComponent)
  },
  ...
  // all deeper paths like /patient/dashboard fall through to this route.
  {
    path: 'patient',
    loadComponent: () =>
      import('./layout/patient-layout/patient-layout.component')
    ...
    children: [
      ...
      },
      {
        path: 'appointments',
        loadComponent: () =>
          import('./features/patient/patient-appointments/patient-appointments.component')
            .then(m => m.PatientAppointmentsComponent)
      },
      {
        path: 'book',
        loadComponent: () =>
          import('./features/patient/patient-book/patient-book.component')
            .then(m => m.PatientBookComponent)
      },
      {
        path: 'profile',
        loadComponent: () =>
